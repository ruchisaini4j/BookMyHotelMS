...
public class Registration {
	...
	public List<String> getCustomerAsList()
	{
		...
		customerDetails.add("CustomerRegistrationId - " + customerRegId);
		customerDetails.add("CustomerName - " + customerName);
		customerDetails.add("Title - " + title);
		customerDetails.add("Address - " + address);
		customerDetails.add("CreditCardNumber - " + creditCardNumber);
		customerDetails.add("Password - " + password);
